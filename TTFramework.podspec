#
#  Be sure to run `pod spec lint TTFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "TTFramework"
  s.version      = "0.0.2"
  s.summary      = "A short description of TTFramework."
  ...
  s.description  = <<-DESC
                    A description of TTFramework.
                   DESC

  s.homepage     = "http://EXAMPLE/TTFramework"
  ...
  s.source       = { :git => "https://github.com/xuzepei/TTFramework.git", :tag => s.version }
